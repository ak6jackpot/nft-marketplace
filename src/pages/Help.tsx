        ...
        <div className="flex flex-col flex-4">
          ...
          <div className="flex flex-row pt-[80px] h-screen">
            ...
            <div className="items-center h-full flex flex-col flex-1">
              <div className="items-center justify-center p-2 m-4 bg-black w-[80%] rounded-xl text-white flex flex-col">
                <span className="items-center justify-center flex my-2">
                  Have any other questions?
                </span>
                {textareaVisible && (
                  <textarea
                    rows={4}
                    className="bg-gray-300 rounded-md w-[90%] text-black p-2"
                  />
                )}
                <div className="bg-white text-black rounded-lg justify-center flex my-2 w-full">
                  <Button
                    onClick={() => {
                      if (textareaVisible) {
                        openSnackbar(
