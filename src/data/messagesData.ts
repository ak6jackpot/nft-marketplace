...
export const messagesData = [
  ...
  },
  {
    ...
    messages: [
      ...
      { text: "To be edited 3", time: 2, incoming: true },
      { text: "To be edited 4", time: 2, incoming: false },
      { text: "To be edited 5", time: 2, incoming: false },
      { text: "To be edited 6", time: 2, incoming: true },
      { text: "To be edited 7", time: 2, incoming: false },
    ],
  },
  {
    name: "Alex Dunphy",
  ...
  },
  {
    ...
    messages: [
      ...
      { text: "Hi Gloria, that's great! ", time: 2, incoming: false },
      {
      ...
      { text: "Please tell me you are joking.", time: 2, incoming: false },
      {
        text: "I am not joking, why will I be joking?",
        time: 2,
        incoming: false,
      },
      { text: "Hey!", time: 2, incoming: false },
      { text: "This is your last chance.", time: 2, incoming: false },
      {
  ...
  },
  {
    ...
    messages: [
      ...
      { text: "Comeon, it'll just be for a week!", time: 1, incoming: true },
      { text: "Let me think about it.", time: 2, incoming: false },
    ],
  },
  {
  ...
  },
  {
    ...
    messages: [
      ...
      { text: " 'ELLO ", time: 2, incoming: true },
      {
      ...
      { text: "How does this Saturday sound?", time: 2, incoming: true },
      { text: "Awesome. Done.", time: 2, incoming: false },
    ],
  },
  {
    name: "Lily Pritchett",
  ...
  },
  {
    ...
    messages: [
      ...
      { text: "Geez Dad.", time: 2, incoming: true },
      {
      ...
      { text: "I think we can arrange something.", time: 2, incoming: false },
    ],
  },
  {
    name: "Joe Pritchett",
